        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <button className="w-full bg-foreground text-background py-3 font-light text-sm tracking-wide uppercase hover:bg-foreground/80 transition-colors duration-300">
                View Project
              </button>
            </div>
          ))}
